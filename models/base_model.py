...
class StockBlockLayer(nn.Module):
    ...
    def spe_seq_cell(self, input):
        ...
        _c = torch.fft.fft(input, dim=-1)
        ffted = torch.stack([_c.real, _c.imag], dim=-1)
        ...
        _ic = torch.complex(time_step_as_inner[..., 0], time_step_as_inner[..., 1])
        iffted = torch.fft.ifft(_ic, dim=-1).real
        return iffted
